...
type StatusOption = "em_operacao" | "parado" | "em_manutencao" | "indisponivel";
...
const MOCK_EQUIPMENT_DATA: Record<string, { equipment: string; quantity: number; hours: number; status: StatusOption; observation: string }> = {
  "1": { equipment: "Retroescavadora", quantity: 1, hours: 8, status: "em_operacao", observation: "" },
  "2": { equipment: "Betoneira", quantity: 2, hours: 6, status: "em_operacao", observation: "" },
  "3": { equipment: "Camião basculante", quantity: 3, hours: 7, status: "em_operacao", observation: "" },
};
  ...
  return (
    <View style={styles.container}>
      <View style={[styles.topNav, { paddingTop: insets.top + 8 }]}>
        ...
        <Text style={styles.navTitle}>Editar equipamento</Text>
          ...
          <View style={styles.field}>
            ...
            >
              <Text style={[styles.dropdownText, !equipment && styles.dropdownPlaceholder]}>
                {isCustomEquipment ? customEquipment || "Inserir nome do equipamento" : equipment || "Selecione um equipamento"}
              </Text>
