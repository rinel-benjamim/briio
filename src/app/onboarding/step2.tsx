...
const IMG = require("@/assets/images/onboarding-img2.png");
    ...
    <View style={styles.container}>
      ...
      <View style={styles.contentBody}>
        ...
        <View style={styles.textBlock}>
          <Text style={styles.title}>Gerencie a sua equipa</Text>
          <Text style={styles.description}>
            Controle a mão de obra, funções e horas trabalhadas em cada obra.
          </Text>
        </View>
      </View>
